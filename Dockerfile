...
RUN /usr/local/bin/composer global require phpunit/phpunit -vvv
RUN /usr/local/bin/composer create-project laravel/laravel /var/www/laravel "5.0.*" --prefer-dist -vvv
